...
// espaçamento constante (pitch único — ver calcLedPitch), retornando também
// o ângulo tangente do caminho em cada ponto (para desenhar o módulo
// acompanhando a curva/perímetro).
